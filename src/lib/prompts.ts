...
export const createProductSummaryPrompt = (dataForAI: AiInputData): string => {
  return `You are a data processing expert. Your only job is to populate a JSON object based on the provided raw data.
    **Instructions:**
      ...
      5.  **Important Specs:** From the 'specifications' object and 'fullDescription', identify the 4-6 most important technical specifications for 
      ...
      7.  **Return/Warranty/Replacement:** Analyze 'serviceInfoText' to find 'returnPolicy', 'replacementinfo' and 'warranty'. If not found, set value to "Not specified".
